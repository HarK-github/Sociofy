...
const Home = ({user}:interfaces.Homeele) => {
  ...
  return (
    <div className="relative w-full min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 overflow-hidden">
        ...
        <div className="w-full lg:flex-1 lg:max-w-3xl space-y-8 z-10 order-2 lg:order-1">
                  ...
                  return (
                    <div key={u._id} className="flex items-center justify-between group">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-green-300 to-pink-300"></div>
                        <div>
          ...
          >
            <div className="flex items-center gap-3 p-3 hover:bg-gray-50 rounded-xl transition-colors">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-green-400 to-pink-400"></div>
        ...
        <aside className="hidden lg:block w-80 space-y-6 order-1 lg:order-2">
          <div className="bg-white rounded-2xl shadow-sm p-5 border border-gray-100 sticky top-24">
            <div className="flex items-center gap-3 mb-6 pb-6 border-b border-gray-100">
              <div className="w-14 h-14 rounded-full bg-gradient-to-br from-green-400 to-pink-400 hover:scale-105 transition-transform cursor-pointer"></div>
              <div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="w-11 h-11 rounded-full overflow-hidden cursor-pointer group-hover:scale-105 transition-transform">
                        {profileImg ? (
                          ...
                          <div className="w-full h-full rounded-full bg-gradient-to-br from-green-300 to-pink-300"></div>
                        )}
                      </div>
      ...
      <button
        onClick={() => setShowCreatePost(true)}
        className="fixed bottom-8 right-8 lg:hidden w-16 h-16 bg-gradient-to-r from-green-600 to-pink-600 text-white rounded-full shadow-2xl flex items-center justify-center transform hover:scale-110 transition-all z-50"
      >
